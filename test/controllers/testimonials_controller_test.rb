...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { description: @testimonial.description, image: @testimonial.image, name: @testimonial.name, place: @testimonial.place }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { description: @testimonial.description, image: @testimonial.image, name: @testimonial.name, place: @testimonial.place }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
