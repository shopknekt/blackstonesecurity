...
$color = ["green", "purple", "skyblue", "red", "pink", "orange", "yellow", "graasgreen", "radiantorchid", "chillipepper"];
$colors = "";
...
$str += '<div class="haircut-style-picker-wrapper">';
$str += '	<a href="" title="" class="style-picker-ico"> <i class="fa fa-cog fa-spin"></i> </a>';
$str += '	<div id="haircut-style-picker">';
...
jQuery(document).ready(function($){
	...
	$picker_container = $("div.haircut-style-picker-wrapper");
