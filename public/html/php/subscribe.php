<?php
	...
	if($lists) {
		...
		if($mcapi->listSubscribe($list_id, $_REQUEST['mc_email'], $merge_vars ) ):
			echo '<div class="dt-sc-success-box"><i class="fa fa-check-circle"></i><strong>Success!</strong>Check your inbox or spam folder for a message containing a confirmation link.</div>';
		else:
